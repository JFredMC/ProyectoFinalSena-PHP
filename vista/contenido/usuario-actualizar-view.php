...
<div class="container">
    <div class="row">
      <div class="col-md-12">
        <h3 class="text-center mt-2" >Actualizar datos de usuario</h3>
...
?>
	...
	<form  class="form-neon justify-content-center FormularioAjax" action="<?php echo SERVERURL; ?>ajax/usuarioAjax.php" method="POST" data-form="update" autocomplete="off">
				...
				<div class="row">
					<div class="col-12 col-md-4">
						<div class="form-group">
							<label for="usuario_dni" class="bmd-label-floating">Identificacion</label>
							<input type="text" pattern="[0-9-]{7,20}" class="form-control" name="usuario_dni_up" id="usuario_dni" maxlength="20" value="<?php echo $campos['usuario_dni']; ?>">
						</div>
					</div>
        ...
        <fieldset>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-12 col-md-6">
						<div class="form-group">
							<select class="form-control" name="usuario_cargo_up">
								<option value="Coordinador" <?php if($campos['usuario_cargo']=='Coordinador'){ echo 'selected=""'; } ?>>Coordinador <?php if($campos['usuario_cargo']=='Coordinador'){ echo ' (Actual)'; } ?></option>

								<option value="Instructor" <?php if($campos['usuario_cargo']=='Instructor'){ echo 'selected=""'; } ?>>Instructor<?php if($campos['usuario_cargo']=='Instructor'){ echo ' (Actual)'; } ?></option>
							</select>
						</div>
					</div>
				</div>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-12 col-md-6">
						...
						<p><span class="badge badge-success">Instructor</span> Permisos para ver horarios</p>
						<div class="form-group">
							<select class="form-control" name="usuario_privilegio_up">
								
								<option value="1" <?php if($campos['usuario_privilegio']==1) {
									echo' selected=""';} ?>>Administrador <?php if($campos['usuario_privilegio']==1) {
										echo'(Actual) ';} ?></option>

								<option value="2" <?php if($campos['usuario_privilegio']==2) {
									echo' selected=""';} ?>>Estandar <?php if($campos['usuario_privilegio']==2) {
										echo'(Actual)';} ?></option>
